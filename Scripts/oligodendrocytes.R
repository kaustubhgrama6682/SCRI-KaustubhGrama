...
undersample_odds <- sum(training.data$Main_cluster_name == "Oligodendrocytes")/sum(training.data$Main_cluster_name != "Oligodendrocytes")
...
seuobj110$predicted_oligodendrocytes_temp <- predicted.classes

seuobj110$probabilities_neg <- 1-probabilities

DimPlot(seuobj110, group.by = "predicted_oligodendrocytes_temp")
...
# 
saveRDS(step.model.both, "/Users/kaustubhgrama/Desktop/Computer_Science/R/Data/fetal_cerebellar_scData/models/step.model.both_oligodendrocytes.RDS")
