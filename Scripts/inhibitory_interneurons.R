...
topgenes_aic <- c("NXPH2", "NRXN3", "MIR137HG", "PAX2", "NKAIN2", "SPOCK1", "VCAN", "IMPDH2", "SLITRK3", "ENC1", "TCF4", "UNC5C", "NNAT", "TENM4")
...
training.data.topgenes <- training.data[, c(topgenes_aic, "Main_cluster_name")]
testing.data.topgenes <- testing.data[, c(topgenes_aic, "Main_cluster_name")]
...
saveRDS(model_lm, "/Users/kaustubhgrama/Desktop/Computer_Science/R/Data/fetal_cerebellar_scData/models/model_lm_inhibitory_interneurons.RDS")
