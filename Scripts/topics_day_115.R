...
seuobj115 <- readRDS(file = "/Users/kaustubhgrama/Downloads/SCRI/seuobj115.RDS")

day89df <- as_data_frame(seuobj115@meta.data)
...
day94df <-  as_data_frame(seuobj115@meta.data)
...
day110df <-  as_data_frame(seuobj115@meta.data)
...
day115df <-  as_data_frame(seuobj115@meta.data)

topic_cols_115 <- grep("^Topic_", names(day115df), value = TRUE)
...
day125df <-  as_data_frame(seuobj115@meta.data)

topic_cols_125 <- grep("^Day125_Topic_", names(day115df), value = TRUE)
...
seuobj115@meta.data$highest_topic <- day115df$highest_topic
seuobj115@meta.data$second_highest_topic <- day115df$second_highest_topic
seuobj115@meta.data$third_highest_topic <- day115df$third_highest_topic
