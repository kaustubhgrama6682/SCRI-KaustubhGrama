...
seuobj125_granuleneurons <- readRDS(file = "/Users/kaustubhgrama/Downloads/SCRI/seuobj125_granuleneurons.RDS")

days <- c("89", "94", "110", "115", "125")

for(day in days){
  
  df <- as.data.frame(seuobj125_granuleneurons@meta.data)
  ...
  code2 <- paste0(
    "seuobj125_granuleneurons@meta.data$highest_topic", day, "  <- df$highest_topic", day, "
  seuobj125_granuleneurons@meta.data$second_highest_topic", day, "  <- df$second_highest_topic", day, "
  seuobj125_granuleneurons@meta.data$third_highest_topic", day, "  <- df$third_highest_topic", day
  )
...
pdf("/Users/kaustubhgrama/Downloads/SCRI/seuobj125_granuleneurons_topic_UMAPs/seuobj125_granuleneurons_topic_UMAPs.pdf")

for(day in days){
  code3 <- paste0(
    "p1 <- DimPlot(seuobj125_granuleneurons, 
                reduction = 'umap', 
  ...
  p2 <- DimPlot(seuobj125_granuleneurons, 
                reduction = 'umap', 
  ...
  p3 <- DimPlot(seuobj125_granuleneurons, 
                reduction = 'umap', 
  ...
  # basepath <- '/Users/kaustubhgrama/Downloads/SCRI/seuobj125_granuleneurons_topic_UMAPs/'
  # 
...
metadata <- seuobj125_granuleneurons@meta.data[,grep("highest", colnames(seuobj125_granuleneurons@meta.data))]

write.table(metadata, file = "/Users/kaustubhgrama/Downloads/SCRI/seuobj125_granuleneurons_topic_UMAPs/metadata.txt", sep = "\t")
